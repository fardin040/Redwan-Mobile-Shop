...
cartRouter.put('/update', cartAuth, async (req, res) => {
...
cartRouter.delete('/clear', cartAuth, async (req, res) => {
  await redis.del(cartKey(req));
  res.json({ success: true, message: 'Cart cleared' });
});

module.exports = { ordersRouter: router, cartRouter };
